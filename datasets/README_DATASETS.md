...
- **Step 6**: Use [``copy_keyword_posts.py``](../query/query/copy_keyword_posts.py) to obtain an initial corpus of posts which contain the co-hashtags selected from Step 5.
